...
* Devops : Docker, CloudFlare, Sentry, Python, 
...
Docker, Kubernetes, FluxCD (GitOps), Helm, OpenFaas, Ansible.

**Scripts :** Python

**Adminsys :** Linux (Debian, Ubuntu),Nginx, Varnish, Redis, ElasticSearch, RabbitMQ

**Cloud :** OVH Cloud, Scaleway, Cloudflare
...
* Maintenir et faire évoluer le cluster de QA (Kubernetes multi-cloud, Scaleway, OVH).
* Préparer et réaliser la migration des instances de production vers un cluster Kubernetes.
* Optimiser l'utilisation des ressources disponibles dans un souci d'économie et d'écologie.
* Travailler en collaboration avec les équipes QA, PO, de Développement.
* Documenter les différentes tâches.
